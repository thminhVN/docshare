...
# Load a local .env file (if present) so `mix phx.server` and releases pick up
# secrets like RESEND_API_KEY without having to export them by hand.
...
#
#     PHX_SERVER=true bin/docshare start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :docshare, DocshareWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :docshare, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
